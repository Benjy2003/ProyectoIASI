...
public class TableroES {
    private final static int N = 10;
    private int Mat[][];
    private List<Moneda> monedas;
    private List<EstadoES> estados;
    ...
    public void mostrar() {
        System.out.println("Algoritmo Heuristico Escalada Simple");
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++) {
    ...
    public boolean existe(EstadoES e) {
        for (EstadoES est : estados) {
            if (est.getH() == e.getH())
                if (est.getX() == e.getX())
                    if (est.getY() == e.getY())
    ...
    public List<EstadoES> getPosiblesMonedasES(Moneda m) {
        List<EstadoES> mov = new ArrayList<>();
        EstadoES e;
        if (Mat[yAct - 1][xAct] != 9) {
            e = new EstadoES(xAct, yAct - 1, acumulado, "A", distanciaHeuristica(xAct, yAct - 1, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        }
        if (Mat[yAct - 1][xAct + 1] != 9) {
            e = new EstadoES(xAct + 1, yAct - 1, acumulado, "AD",
        ...
        if (Mat[yAct][xAct + 1] != 9) {
            e = new EstadoES(xAct + 1, yAct, acumulado, "D", distanciaHeuristica(xAct + 1, yAct, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        ...
        if (Mat[yAct + 1][xAct + 1] != 9) {
            e = new EstadoES(xAct + 1, yAct + 1, acumulado, "BD",
                    distanciaHeuristica(xAct + 1, yAct + 1, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
        ...
        if (Mat[yAct + 1][xAct] != 9) {
            e = new EstadoES(xAct, yAct + 1, acumulado, "B", distanciaHeuristica(xAct, yAct + 1, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        ...
        if (Mat[yAct + 1][xAct - 1] != 9) {
            e = new EstadoES(xAct - 1, yAct + 1, acumulado, "BI",
                    distanciaHeuristica(xAct - 1, yAct + 1, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
        ...
        if (Mat[yAct][xAct - 1] != 9) {
            e = new EstadoES(xAct - 1, yAct, acumulado, "I", distanciaHeuristica(xAct - 1, yAct, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        ...
        if (Mat[yAct - 1][xAct - 1] != 9) {
            e = new EstadoES(xAct - 1, yAct - 1, acumulado, "AI",
                    distanciaHeuristica(xAct - 1, yAct - 1, m.getX(), m.getY()));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
    ...
    public List<EstadoES> getPosiblesSalidaES() {
        List<EstadoES> mov = new ArrayList<>();
        EstadoES e;
        if (Mat[yAct - 1][xAct] != 9) {
            e = new EstadoES(xAct, yAct - 1, acumulado, "A", distanciaHeuristica(xAct, yAct - 1, xFinal, yFinal));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        ...
        if (Mat[yAct][xAct + 1] != 9) {
            e = new EstadoES(xAct + 1, yAct, acumulado, "D", distanciaHeuristica(xAct + 1, yAct, xFinal, yFinal));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        ...
        if (Mat[yAct + 1][xAct] != 9) {
            e = new EstadoES(xAct, yAct + 1, acumulado, "B", distanciaHeuristica(xAct, yAct + 1, xFinal, yFinal));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
        ...
        if (Mat[yAct][xAct - 1] != 9) {
            e = new EstadoES(xAct - 1, yAct, acumulado, "I", distanciaHeuristica(xAct - 1, yAct, xFinal, yFinal));
            if (!existe(e) && esMejor(e)) {
                mov.add(e);
                return mov;
            }
